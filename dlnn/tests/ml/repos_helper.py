...
corr_step_10_a_kernel_init = numpy.array([[+0.03040000, +0.34330000, -0.28470000, +0.21670000, +0.36270000],
...
corr_step_10_a_bias_init = numpy.array([0.71943, 0.65004, 0.72691, 0.37385, 0.58158])
corr_step_10_a_non_bias = numpy.array([[-0.16073523, -0.18061252, -0.79366340, 0.15487751, 1.09136570],
...
corr_step_10_a = numpy.array([[+0.55869480, +0.46942747, -0.06675339, +0.52872753, +1.67294570],
...
corr_step_11_a = numpy.array([[0.63615050, 0.61524820, 0.48331788, 0.62918630, 0.84196820],
...
corr_step_10_b_kernel_init = numpy.array(
...
corr_step_11_b = numpy.array(
    [[0.65532786, 0.83697880, 0.53406274, 0.47085887, 0.44543025, 0.76940250, 0.55507344],
     [0.65530956, 0.83699113, 0.53407484, 0.47081104, 0.44546384, 0.76940320, 0.55509780],
     [0.65526080, 0.83697910, 0.53408630, 0.47077188, 0.44551125, 0.76939774, 0.55512786],
     [0.65524430, 0.83693683, 0.53412557, 0.47073570, 0.44563073, 0.76936746, 0.55521774],
     [0.65523970, 0.83690387, 0.53415626, 0.47071300, 0.44572157, 0.76934326, 0.55528706],
     [0.65523030, 0.83654250, 0.53379810, 0.47176626, 0.44488750, 0.76936275, 0.55461746],
     [0.65526240, 0.83656424, 0.53377770, 0.47180040, 0.44481880, 0.76937664, 0.55456870],
     [0.65526813, 0.83652980, 0.53375480, 0.47188440, 0.44476670, 0.76937336, 0.55452734]]
)
corr_step_10_c_kernel_init = numpy.array([[+0.37351000, -0.42978000, +0.48754000, +0.42271000],
                                          [+0.06426100, -0.06853800, -0.16216000, +0.22072000],
                                          [-0.48634000, -0.12594000, +0.42269000, +0.04648000],
                                          [-0.02611300, -0.00346270, -0.19103000, +0.45084000],
                                          [+0.48199000, +0.01356300, +0.49259000, -0.04415600],
                                          [-0.07395900, -0.28679000, -0.30675000, +0.33275000],
                                          [+0.22664000, +0.02974600, +0.32908000, +0.01187400],
                                          [+0.05196200, -0.28672000, +0.08782100, -0.35724000],
                                          [-0.44778000, +0.18331000, +0.10856000, -0.28034000],
                                          [-0.09372000, +0.12991000, +0.05530800, -0.37242000],
                                          [-0.33080000, -0.49900000, -0.08183800, -0.01151400],
                                          [-0.34013000, +0.16684000, -0.48208000, -0.38032000]])
corr_step_10_c_bias_init = numpy.array([0.95213000, 0.97585000, 0.03091500, 0.49388000])
corr_step_10_c_non_bias = numpy.array([[-0.28621715, -0.72040063, +0.48689390, +0.01368549],
                                       [-0.28618532, -0.72045090, +0.48693395, +0.01357793],
                                       [-0.28622884, -0.72030790, +0.48678637, +0.01326433],
                                       [-0.28599352, -0.72005975, +0.48663688, +0.01299679],
                                       [-0.28578870, -0.71987940, +0.48654008, +0.0128325],
                                       [-0.28812855, -0.71752240, +0.48405713, +0.01306194],
                                       [-0.28819057, -0.71768890, +0.48419023, +0.01332711],
                                       [-0.28832110, -0.71748230, +0.48399390, +0.01335514]])
corr_step_10_c = numpy.array([[0.66591287, 0.25544935, 0.51780890, 0.50756550],
                              [0.66594470, 0.25539910, 0.51784897, 0.50745790],
                              [0.66590120, 0.25554210, 0.51770140, 0.50714433],
                              [0.66613650, 0.25579023, 0.51755190, 0.50687677],
                              [0.66634130, 0.25597060, 0.51745510, 0.50671250],
                              [0.66400146, 0.25832760, 0.51497215, 0.50694190],
                              [0.66393950, 0.25816107, 0.51510525, 0.50720710],
                              [0.66380894, 0.25836766, 0.51490890, 0.50723517]])
corr_step_11_c = numpy.array([[0.66058743, 0.56351733, 0.62663530, 0.62423563],
                              [0.66059446, 0.56350493, 0.62664470, 0.62421036],
                              [0.66058475, 0.56354010, 0.62661016, 0.62413680],
                              [0.66063750, 0.56360114, 0.62657510, 0.62407400],
                              [0.66068345, 0.56364554, 0.62655246, 0.62403550],
                              [0.66015870, 0.56422514, 0.62597130, 0.62408930],
                              [0.66014480, 0.56418420, 0.62600250, 0.62415150],
                              [0.66011554, 0.56423500, 0.62595654, 0.62415814]])
